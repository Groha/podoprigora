 ...
 */            (function(window, factory) {
        ...
        943: function(module, __unused_webpack_exports, __webpack_require__) {
            /*!
 * imagesLoaded v5.0.0
 ...
 */
            (function(window, factory) {
                if (true && module.exports) module.exports = factory(window, __webpack_require__(228)); else window.imagesLoaded = factory(window, window.EvEmitter);
    ...
    (() => {
        ...
        function initSliders() {
            ...
            function handleBreakpointChange(e) {
                if (e.matches) initSlider(); else destroySlider();
            }
            if (mediaQuery.matches) initSlider();
...
***************************************************************************** */
        ...
        if (items) imagesloaded(items, (function() {
            new isotope(items, {
        ...
        if (!localStorage.getItem("theme") && window.matchMedia("(prefers-color-scheme: dark)").matches) document.body.classList.add("dark-theme");
        const savedTheme = localStorage.getItem("theme");
        if (savedTheme === "dark-theme") document.body.classList.add("dark-theme"); else if (savedTheme === "") document.body.classList.remove("dark-theme");
        ...
        if (toggleBtn) toggleBtn.addEventListener("click", (() => {
            ...
            setTheme(isDark ? "" : "dark-theme");
        }));
        document.addEventListener("click", (e => {
            const target = e.target;
            if (target.classList.contains("theme-toggle__dark")) setTheme("dark-theme");
            if (target.classList.contains("theme-toggle__light")) setTheme("");
        }));
        window["FLS"] = true;
        menuInit();
        spollers();
